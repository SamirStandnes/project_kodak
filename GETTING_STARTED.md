...
3.  **Get AI Context:** Run this command to analyze the file:
    ```powershell
    python -m scripts.maintenance.inspect_file data/new_raw_transactions/coinbase/your_file.csv
    ```
4.  **Generate Parser:** 
...
5.  **Save:** Create a file named `scripts/pipeline/parsers/coinbase.py` and paste the AI's code inside.
