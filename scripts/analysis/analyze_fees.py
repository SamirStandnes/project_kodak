...
def analyze_fees():
    ...
    # 2. By Currency
    table_curr = Table(title="Fees by Currency", show_header=True, header_style="bold magenta")
    ...
    # 3. Top Fees
    table_top = Table(title="Largest Fees", show_header=True, header_style="bold magenta")
    table_top.add_column("Date", justify="center")
    table_top.add_column("Description")
